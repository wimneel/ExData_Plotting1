...
# Set graphics device to PNG and plot "Global Active Power" as a function of time.
# Save the result as a 480 x 480 pixel (the default) PNG file called plot2.png.
png("plot2.png")
